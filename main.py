...
class Plane:
    ...
    def call_ai(self: Plane, enemy: Plane, bullets: list[Bullet]) -> (float, bool):
...
def tick():
    ...
    plane1.rotation = plane1_new_rotation
    plane1.shooting = plane1_shooting

    plane2.rotation = plane2_new_rotation
