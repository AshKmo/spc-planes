...
- Your code also must not depend on any external libraries, except for NumPy, which you are free to use. You are also still allowed to use any of the built-in Python modules such as `math`, `numbers`, etc.
- Try not to vibecode
